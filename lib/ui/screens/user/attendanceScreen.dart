...
import 'package:burhaniguardsapp/ui/screens/user/attendanceCalendar.dart';
...
class AttendanceMemberListScreen extends StatefulWidget {
  const AttendanceMemberListScreen({Key? key}) : super(key: key);

  @override
  State<AttendanceMemberListScreen> createState() =>
      _AttendanceMemberListScreenState();
}

class _AttendanceMemberListScreenState
    extends State<AttendanceMemberListScreen> {
  @override
      ...
      child: InkWell(
          onTap: () {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                  builder: (_) => const CalendarAttendanceScreen()),
            );
          },
          child: Row(
            children: [
