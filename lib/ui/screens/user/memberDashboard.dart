...
class HomeMiqaatScreen extends StatefulWidget {
  const HomeMiqaatScreen({Key? key}) : super(key: key);

  @override
  State<HomeMiqaatScreen> createState() => _HomeMiqaatScreenState();
}
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Current Miqaat Horizontal Scroll
                    SizedBox(
                      height: 180,
                      child: ListView(
    ...
    return Container(
      ...
      child: InkWell(
          onTap: () {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(builder: (_) => const MiqaatDetailsScreen()),
            );
          },
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
