...
class UpcomingMiqaatScreen extends StatefulWidget {
  const UpcomingMiqaatScreen({Key? key}) : super(key: key);

  @override
  State<UpcomingMiqaatScreen> createState() => _UpcomingMiqaatScreenState();
}
